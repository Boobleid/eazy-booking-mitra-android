...
import com.booble.reservasi.mitra.utils.UtilDialog.setProgressDialog
...
abstract class BaseDialogFragment<viewBinding : ViewBinding> : DialogFragment() {
    ...
    abstract fun showFailure(failure: com.booble.reservasi.mitra.data.network.DataResource.Failure)
